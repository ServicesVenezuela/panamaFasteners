...
@XmlType(name=BodyEntradaConsultaResponsableBean.BODY_ENTRADA_NAME, namespace=ManagerAPIService.TARGET_NAMESPACE, propOrder={"idResponsable"})
public class BodyEntradaConsultaResponsableBean extends BaseBean implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1398073349282790908L;
	
	/** The Constant BODY_ENTRADA_NAME. */
	public static final String BODY_ENTRADA_NAME = "BODY_ENTRADA_CONSULTAR_RESPONSABLE";

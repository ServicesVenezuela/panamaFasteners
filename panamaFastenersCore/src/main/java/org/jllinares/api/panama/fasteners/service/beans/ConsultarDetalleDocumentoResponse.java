...
/**
 * The Class ConsultarDetalleDocumentoResponse.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="CONSULTAR_DETALLE_DOCUMENTOResponse", namespace="FASTENERS_SERVICES_API", propOrder={"headerSalida", "bodySalida"})
public class ConsultarDetalleDocumentoResponse extends BaseBean
  implements Serializable
{
  
  /** The Constant serialVersionUID. */
  private static final long serialVersionUID = -1927454596990058229L;
  ...
  /** The body salida. */
  @XmlElement(name="BODY_SALIDA_CONSULTAR_DETALLE_DOCUMENTO", required=false)
  private BodySalidaConsultarDetalleDocumentoBean bodySalida;
   ...
   */
  public BodySalidaConsultarDetalleDocumentoBean getBodySalida()
  {
   ...
   */
  public void setBodySalida(BodySalidaConsultarDetalleDocumentoBean bodySalida)
  {
